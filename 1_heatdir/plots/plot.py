...
login_run = np.loadtxt("run_data\logindata.txt", delimiter=';')
...
batch = draw_plot(array.T, -0.2, "tomato", "white", "compute node")
login = draw_plot(array2.T, 0.2, "skyblue", "white", "login node")
plt.xticks(range(5), [500,1500,2500,3500,4500])
plt.xlabel("Resolution")
plt.ylabel("MFlops")
ax2.legend([batch["boxes"][0], login["boxes"][0]], ['Compute', 'Login'], loc='upper right')
ax2.set_title("Performance Variation of Best Flag Combination \n for One Node")
