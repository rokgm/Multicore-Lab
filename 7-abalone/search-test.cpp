 ...
 */
class TestStrategy: public SearchStrategy
{
 public:
    // Defines the name of the strategy
    TestStrategy(): SearchStrategy("test") {}

    // Factory method: just return a new instance of this class
    SearchStrategy* clone() { return new TestStrategy(); }
...
void TestStrategy::searchBestMove()
{
